...
--
-- Hôte : localhost:3306
-- Généré le : sam. 15 juin 2024 à 13:27
...
--
ALTER TABLE `pizza`
  ADD PRIMARY KEY (`nomPizza`);

--
-- Index pour la table `pizza_ingredients`
--
ALTER TABLE `pizza_ingredients`
  ADD PRIMARY KEY (`nomPizza`,`nom`),
  ADD KEY `pizza_ingredients_ibfk_2` (`nom`);
...
--
ALTER TABLE `commande`
  MODIFY `numero` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT pour la table `livreur`
--
ALTER TABLE `livreur`
  MODIFY `matricule` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`immatriculation`) REFERENCES `vehicule` (`immatriculation`),
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`matricule`) REFERENCES `livreur` (`matricule`),
  ADD CONSTRAINT `commande_ibfk_3` FOREIGN KEY (`nomPizza`) REFERENCES `pizza` (`nomPizza`),
  ADD CONSTRAINT `commande_ibfk_4` FOREIGN KEY (`idClient`) REFERENCES `client` (`idClient`);

--
-- Contraintes pour la table `pizza_ingredients`
--
ALTER TABLE `pizza_ingredients`
  ADD CONSTRAINT `pizza_ingredients_ibfk_1` FOREIGN KEY (`nomPizza`) REFERENCES `pizza` (`nomPizza`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pizza_ingredients_ibfk_2` FOREIGN KEY (`nom`) REFERENCES `ingredient` (`nom`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
